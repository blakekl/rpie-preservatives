...
sed -in "s/.\/rpie-preservatives.sh.*//" /opt/retropie/configs/all/runcommand-onend.sh 
sed -in "s/.\/rpie-preservatives.sh.*//" /opt/retropie/configs/all/runcommand-onstart.sh 
